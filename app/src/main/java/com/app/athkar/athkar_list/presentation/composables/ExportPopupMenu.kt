...
import com.app.athkar.ui.theme.DividerColor
...
fun ExportPopupMenu(
    ...
    DropdownMenu(modifier = Modifier.background(Color.White),
        ...
        DropdownMenuItem(modifier = Modifier.clickable(
            enabled = false, interactionSource = interactionSource, indication = null
        ) {},
            text = { Text("Export as") },
            onClick = { /* Do nothing! */ },
        ...
        DropdownMenuItem(text = { Text("Image") },
            onClick = { onImageTap() },
            colors = MenuDefaults.itemColors(textColor = ControlsColor)
        )
        HorizontalDivider(color = DividerColor)
